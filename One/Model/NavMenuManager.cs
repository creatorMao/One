    ...
    public static class NavMenuManager
    {
        ...
        public static List<NavMenuItem> CreateNavMenuList(string language)
        {
            ...
            if (language == "zh-CN")
            {
                ...
                list.Add(new NavMenuItem("音乐", "0,117,117,17", "0,96,125,139", "Assets/icon/movie.png", "Assets/icon/movie-selected.png", typeof(MusicPage), false, "#ffffff"));
            ...
            else if(language == "en-US")
            {
                ...
                list.Add(new NavMenuItem("Music", "0,117,117,17", "0,96,125,139", "Assets/icon/movie.png", "Assets/icon/movie-selected.png", typeof(MusicPage), false, "#ffffff"));
